                        ...
                        <div class="make3D">
                            <div class="product-front">
                                ...
                                @elseif(isset($descriptSale['upload_main_picture']))
                                    <img style="max-width: 270px; max-height: 320px;" src="/storage/upload_pictures/{{ $prSale->id }}/{{ $descriptSale['upload_main_picture'] }}" alt="pic" />
                                @else
                            ...
                            <div class="product-back">
                                ...
                                <div class="carousel">
                                    <ul class="carousel-container">
                                        ...
                                        @elseif(isset($descriptSale['upload_main_picture']))
                                            <li><img style="max-width: 270px; max-height: 320px;" src="/storage/upload_pictures/{{ $prSale->id }}/{{ $descriptSale['upload_main_picture'] }}" alt="pic" /></li>
                                        @else
                                                ...
                                                @foreach($type_pictures as $key_picture => $picture)
                                                    <li>
                                                        @if($key_picture == 'upload_picture')
                                                            <img style="max-width: 270px; max-height: 320px;" src="/storage/upload_pictures/{{ $prSale->id }}/{{ $type_pictures[$key_picture] }}">
                                                        @else
