...
class InfoCompanyController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($request->hasFile('watermark'))
        {
            ...
            $fileNameToStore = 'watermark.'.$extension;
            $path = $request->file('watermark')->storeAs('public/common_pictures/', $fileNameToStore);
            $watermark_name = $fileNameToStore;
        }
        else
        {
            $watermark_name = '';
        ...
        $infoCompany->watermark       = $watermark_name;
    ...
    public function update(Request $request, $id)
    {
        ...
        {
            $watermark_name = $request->input('watermark_name');
        }
    ...
    public function destroy($id)
    {
        ...
        Storage::delete('public/common_pictures/watermark.png');
